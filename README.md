...
* [aka.ms/commands](https://github.com/microsoft/aka) ⭐ 456 | 🐛 20 | 📅 2024-10-30 - List of common Microsoft short links.
...
* [Evilginx](https://github.com/kgretzky/evilginx2) ⭐ 15,518 | 🐛 271 | 🌐 Go | 📅 2026-06-10 - Man-in-the-middle attack framework [![stars](https://badgen.net/github/stars/kgretzky/evilginx2)](https://badgen.net/github/stars/kgretzky/evilginx2)
* [BloodHound](https://github.com/BloodHoundAD/BloodHound) ⭐ 10,602 | 🐛 93 | 🌐 PowerShell | 📅 2026-03-02 - BloodHound uses graph theory to reveal hidden relationships and attack paths in an Active Directory environment that would otherwise be impossible to quickly identify. [![stars](https://badgen.net/github/stars/BloodHoundAD/BloodHound)](https://badgen.net/github/stars/BloodHoundAD/BloodHound)
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,795 | 🐛 295 | 🌐 Python | 📅 2025-09-23 - Multi-Cloud Security auditing tool. [![stars](https://badgen.net/github/stars/nccgroup/ScoutSuite)](https://badgen.net/github/stars/nccgroup/ScoutSuite)
* [Ping Castle](https://github.com/vletoux/pingcastle) ⭐ 2,930 | 🐛 59 | 🌐 C# | 📅 2026-08-11 - Security Assessment Tool [![stars](https://badgen.net/github/stars/vletoux/pingcastle)](https://badgen.net/github/stars/vletoux/pingcastle)
...
* [Microsoft365DSC](https://github.com/microsoft/Microsoft365DSC) ⭐ 2,373 | 🐛 69 | 🌐 PowerShell | 📅 2026-08-20 - Manages, configures, extracts and monitors Microsoft 365 tenant configurations using PowerShell DSC [![stars](https://badgen.net/github/stars/microsoft/Microsoft365DSC)](https://badgen.net/github/stars/microsoft/Microsoft365DSC)
...
* [Maester](https://github.com/maester365/maester) ⭐ 1,067 | 🐛 48 | 🌐 HTML | 📅 2026-08-18 - Automated test framework for conditional access and Entra configuration [![stars](https://badgen.net/github/stars/maester365/maester)](https://badgen.net/github/stars/maester365/maester)
...
* [TokenTacticsV2](https://github.com/f-bader/TokenTacticsV2) ⭐ 447 | 🐛 1 | 🌐 PowerShell | 📅 2026-08-17 - Fork of the great TokenTactics with support for CAE and token endpoint. [![stars](https://badgen.net/github/stars/f-bader/TokenTacticsV2)](https://badgen.net/github/stars/f-bader/TokenTacticsV2)
...
* [AzurePrivilegedIAM](https://github.com/Cloud-Architekt/AzurePrivilegedIAM) ⭐ 202 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21 - Docs and samples for privileged identity and access management in Microsoft Azure and Microsoft Entra [![stars](https://badgen.net/github/stars/Cloud-Architekt/AzurePrivilegedIAM)](https://badgen.net/github/stars/Cloud-Architekt/AzurePrivilegedIAM)
...
* [Dalonso-Security-Repo](https://github.com/davidalonsod/Dalonso-Security-Repo) ⭐ 117 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2026-08-21 - This space is dedicated to sharing knowledge, tools, and practical examples related to Microsoft Security technologies.
